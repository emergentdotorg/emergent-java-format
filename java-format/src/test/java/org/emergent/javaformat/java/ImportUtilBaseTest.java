...
public class ImportUtilBaseTest {
    ...
    public ImportUtilBaseTest(String input, String expected) {
        this.input = input;
    ...
    public void removeUnused() throws FormatterException {
        Truth.assertThat(new ImportUtilBase().removeUnusedImports(input)).isEqualTo(expected);
    }
}
