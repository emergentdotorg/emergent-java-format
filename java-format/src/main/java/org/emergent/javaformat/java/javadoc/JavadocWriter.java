...
import static org.emergent.javaformat.java.javadoc.JavadocWriter.AutoIndent.AUTO_INDENT;
import static org.emergent.javaformat.java.javadoc.JavadocWriter.AutoIndent.NO_AUTO_INDENT;
import static org.emergent.javaformat.java.javadoc.JavadocWriter.RequestedWhitespace.BLANK_LINE;
import static org.emergent.javaformat.java.javadoc.JavadocWriter.RequestedWhitespace.NEWLINE;
import static org.emergent.javaformat.java.javadoc.JavadocWriter.RequestedWhitespace.NONE;
import static org.emergent.javaformat.java.javadoc.JavadocWriter.RequestedWhitespace.WHITESPACE;
 ...
 *
 * <p>Our Javadoc formatter doesn't ever generate a parse tree, only a stream of tokens, so the writer must compute and
...
final class JavadocWriter {
    ...
    /**
     * Tokens that are always pinned to the following token. For example, {@code <p>} in {@code <p>Foo bar} (never
     * {@code <p> Foo bar} or {@code <p>\nFoo bar}).
     *
     * <p>This is not the only kind of "pinning" that we do: See also the joining of LITERAL tokens done by the lexer.
