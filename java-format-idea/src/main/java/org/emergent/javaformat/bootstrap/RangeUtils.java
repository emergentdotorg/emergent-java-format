...
public final class RangeUtils {
    ...
    /** Returns a range representation as parsed by "org.emergent.javaformat.java.CommandLineOptionsParser". */
    public static String toStringRange(Range<Integer> range) {
