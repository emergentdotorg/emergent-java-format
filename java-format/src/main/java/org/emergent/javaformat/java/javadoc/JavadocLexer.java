...
package org.emergent.javaformat.java.javadoc;

import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.base.Preconditions.checkNotNull;
import static com.google.common.base.Verify.verify;
import static com.google.common.collect.Iterators.peekingIterator;
import static org.emergent.javaformat.java.javadoc.Token.Type.BEGIN_JAVADOC;
import static org.emergent.javaformat.java.javadoc.Token.Type.BLOCKQUOTE_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.BLOCKQUOTE_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.BR_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.CODE_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.CODE_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.END_JAVADOC;
import static org.emergent.javaformat.java.javadoc.Token.Type.FOOTER_JAVADOC_TAG_START;
import static org.emergent.javaformat.java.javadoc.Token.Type.FORCED_NEWLINE;
import static org.emergent.javaformat.java.javadoc.Token.Type.HEADER_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.HEADER_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.HTML_COMMENT;
import static org.emergent.javaformat.java.javadoc.Token.Type.INLINE_TAG_CLOSE;
import static org.emergent.javaformat.java.javadoc.Token.Type.INLINE_TAG_OPEN;
import static org.emergent.javaformat.java.javadoc.Token.Type.LIST_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.LIST_ITEM_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.LIST_ITEM_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.LIST_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.LITERAL;
import static org.emergent.javaformat.java.javadoc.Token.Type.MOE_BEGIN_STRIP_COMMENT;
import static org.emergent.javaformat.java.javadoc.Token.Type.MOE_END_STRIP_COMMENT;
import static org.emergent.javaformat.java.javadoc.Token.Type.OPTIONAL_LINE_BREAK;
import static org.emergent.javaformat.java.javadoc.Token.Type.PARAGRAPH_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.PARAGRAPH_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.PRE_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.PRE_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.TABLE_CLOSE_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.TABLE_OPEN_TAG;
import static org.emergent.javaformat.java.javadoc.Token.Type.WHITESPACE;
...
final class JavadocLexer {
    ...
    /**
     * Where the input has two consecutive line breaks between literals, insert a {@code <p>} tag between the literals.
     *
     ...
     * either {@code <a href=foo>foo</a>} or {@code <a href=foo>\nfoo</a>}, depending on how much space we have left on
     * the line.
     *
     * <p>This method must be called after {@link #joinAdjacentLiteralsAndAdjacentWhitespace}, as it assumes that
     * adjacent whitespace tokens have already been joined.
