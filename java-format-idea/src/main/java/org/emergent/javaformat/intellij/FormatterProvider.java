...
import org.emergent.javaformat.bootstrap.BootstrappingFormatterService;
import org.emergent.javaformat.bootstrap.NativeImageFormatterService;
import org.emergent.javaformat.java.FormatterService;
import org.emergent.javaformat.java.FormatterServiceImpl;
...
final class FormatterProvider {
    ...
    private static Optional<FormatterService> createFormatter(FormatterCacheKey cacheKey) {
        if (true) return Optional.of(new FormatterServiceImpl());
