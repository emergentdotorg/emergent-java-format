...
package org.emergent.javaformat.doc;
...
import org.emergent.javaformat.Output;

/**
 * {@link org.emergent.javaformat.java.JavaInputAstVisitor JavaInputAstVisitor} outputs a sequence of {@link Op}s using
 * {@link OpsBuilder}. This linear sequence is then transformed by {@link DocBuilder} into a tree-structured
 * {@code Doc}. The top-level {@code Doc} is a {@link Level}, which contains a sequence of {@code Doc}s, including other
 * {@link Level}s. Leaf {@code Doc}s are {@link Token}s, representing language-level tokens; {@link Comment}s, which may
 * also represent non-token {@link Input.Tok}s, including comments and other white-space; {@link NonBreakingSpace}s,
