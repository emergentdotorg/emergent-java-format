...
import org.emergent.javaformat.CommentsHelper;
import org.emergent.javaformat.FormattingError;
import org.emergent.javaformat.InstanceProvider;
import org.emergent.javaformat.Op;
import org.emergent.javaformat.OpsBuilder;
import org.emergent.javaformat.OpsBuilder.OpsOutput;
import org.emergent.javaformat.Utils;
import org.emergent.javaformat.doc.Doc;
import org.emergent.javaformat.doc.DocBuilder;
import org.emergent.javaformat.doc.Level;
import org.emergent.javaformat.doc.NoopSink;
import org.emergent.javaformat.doc.Obs;
import org.emergent.javaformat.doc.Obs.Sink;
import org.emergent.javaformat.doc.State;
...
public final class Formatter {
    ...
    static JavaOutput format(
        ...
        //     visitor = createVisitor("org.emergent.javaformat.java.java21.Java21InputAstVisitor", opsBuilder, options);
        // } else if (getRuntimeVersion() >= 14) {
        //     visitor = createVisitor("org.emergent.javaformat.java.java14.Java14InputAstVisitor", opsBuilder, options);
        // } else {
        //     visitor = new JavaInputAstVisitor(opsBuilder, options.indentationMultiplier());
        // }

        visitor = InstanceProvider.getInstance().newJavaInputAstVisitor(opsBuilder, options.indentationMultiplier());
    ...
    public String formatSourceAndFixImports(String input) throws FormatterException {
        ...
        input = InstanceProvider.getInstance().imports().removeUnusedImports(input);
    ...
    public String fixImports(String input) throws FormatterException {
        return ImportOrderer.reorderImports(InstanceProvider.getInstance().imports().removeUnusedImports(input), options.style());
    }
