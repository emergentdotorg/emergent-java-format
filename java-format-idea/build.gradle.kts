...
dependencies {
    ...
    implementation(project(":java-format"))
    //"formatter"(project(path = ":java-format", configuration = "uber"))
    ...
    //testImplementation(project(path = ":java-format"))
...
tasks {
    ...
    //    args.addAll(gjfRequiredJvmArgs)
    //}
    runIde {
        //args.addAll(gjfRequiredJvmArgs)
